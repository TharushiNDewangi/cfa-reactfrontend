...
console.log("ddddd");
    useEffect(() => {
        function getPapers() {
            ...
            // console.log('user token'+config);
              axios.get( 
                'https://iconconferenceapp.herokuapp.com/api/approvep/',
                config
              ).then((res) => {
                setPapers(res.data);
                    ...
                    {/* <a href="http://localhost:8065/uploads/test.pdf" download> */}
                     ...
                     {/* <i class="text-danger bi bi-download" ></i>  */}
                                ...
                                <td>
                                    ...
                                    axios.put(`https://iconconferenceapp.herokuapp.com/api/paper/approveper/${papers._id}`,config)
                                    .then(res=>{
                                               alert("approved");
                                                console.log('added');
                                            })
                                    ...
                                    <button onClick={e => 
                                    axios.put(`https://iconconferenceapp.herokuapp.com/api/paper/rejectpaper/${papers._id}`,config)
                                    .then(res=>{
                                               alert("Rejected");
                                                console.log('added');
                                            })
