...
console.log("ddddd");
    useEffect(() => {
        function getConference() {
            axios.get("https://iconconferenceapp.herokuapp.com/api/conference/approve/getapproveconference/").then((res) => {
            ...
            <Container>
                ...
                <tbody>{conference.filter((p)=>p.status == "pending").map((conference, index) => (
                            ...
                            key={conference._id}>{conference.title}</td>
                                ...
                                <td>
                                    <button onClick={e => 
                                    axios.put(`https://iconconferenceapp.herokuapp.com/api/conference/approveconference/${conference._id}`)
                                    .then(res=>{
                                               alert("approved");
                                                console.log('added');
                                            })
                                    ...
                                    <button onClick={e => 
                                    axios.put(`https://iconconferenceapp.herokuapp.com/api/conference/rejectconference/${conference._id}`)
                                    .then(res=>{
                                               alert("Rejected");
                                                console.log('added');
                                            })
